...
<body>
    <div id="container">
        <svg class="background-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
            <path fill="#778c86" fill-opacity="0.8" d="M0,0L60,26.7C120,53,240,107,360,117.3C480,128,600,96,720,96C840,96,960,128,1080,154.7C1200,181,1320,203,1380,213.3L1440,224L1440,0L1380,0C1320,0,1200,0,1080,0C960,0,840,0,720,0C600,0,480,0,360,0C240,0,120,0,60,0L0,0Z"></path>
        </svg>
        <!---------- NAVBAR ---------->
        <nav class="navbar">
            <h1>OddsToEnds</h1>
        ...
        <div class="content-1">
            ...
            <div class="content-text">
                <svg class="house-logo" version="1.0" xmlns="http://www.w3.org/2000/svg" width="300.000000pt"
                    ...
                    <g transform="translate(0.000000,231.000000) scale(0.100000,-0.100000)" fill="#778C86"
                        stroke="none">
